defmodule OsCmdTest do
  ...
  test "executes the specified kill command" do
    {:ok, pid1} = OsCmd.start_link(~w/sleep infinity/)
    Process.monitor(pid1)

    {:ok, pid2} = OsCmd.start_link({~w/sleep infinity/, kill_cmd: "killall sleep"})
